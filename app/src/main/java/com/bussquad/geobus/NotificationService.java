...
public class NotificationService extends Service {
    ...
    private  Runnable busCheck = new Runnable() {
        ...
        public void run() {
            ...
            System.out.println("notification service running: size " +notifDb.numberOfNotifications() );
...
//                    stopSelf();
    ...
    public void updateNotification(String stopID){
        ...
        if (stopsLeft == 0){
            System.out.println("number of notificaitons: " + notifDb.numberOfNotifications());
