...
public class JsonBusFileReader {
    ...
    private Bus readBus(JsonReader reader) throws IOException {
        ...
        while (reader.hasNext()) {
            ...
            } else if (name.equals("bus_type") && reader.peek() != JsonToken.NULL) {
                type = reader.nextString();
            }else if (name.equals("direction") && reader.peek() != JsonToken.NULL) {
        ...
        reader.endObject();
        return new Bus(id ,latitude,longitude,type,direction);
    }
