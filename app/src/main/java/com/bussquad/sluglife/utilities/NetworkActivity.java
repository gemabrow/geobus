...
import com.bussquad.sluglife.parser.JsonBusFileReader;
...
import static com.bussquad.sluglife.activity.MainActivity.*;
...
class NetworkActivity {
    ...
    private String URL3 = "http://ec2-52-10-153-244.us-west-2.compute.amazonaws.com/bustojson.php";
    ...
    // sets the url to get the json file from
...
//        new DownloadJsonTask().execute(URL2);
    ...
    private class DownloadJsonTask extends AsyncTask<String, Void , ArrayList<Bus>>{
        ...
        // set markers to MainActivity which are then drawn on the map
        @Override
        protected void onPostExecute(ArrayList<Bus> result) {
            try{
                activity.setMarkers(result);
